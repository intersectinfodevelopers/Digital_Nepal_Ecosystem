...
public enum AuditEventType {
    ...
    // Once-Only Evidence Exchange (Governance Tiers §7)
    EVIDENCE_REQUEST_CREATED,
    EVIDENCE_REQUEST_RESPONDED,
    EVIDENCE_REQUEST_FAILED,
    EVIDENCE_REQUEST_EXPIRED,

    // External Relying-Party Gateway (Extended Modules §6.1-6.5)
    RELYING_PARTY_LICENSED,
    RELYING_PARTY_SUSPENDED,
    RELYING_PARTY_REVOKED,
    GATEWAY_VERIFY_SUCCESS,
    GATEWAY_VERIFY_DENIED,
    GATEWAY_CONSENT_CONFIRMED,
